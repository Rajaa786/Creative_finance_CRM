# Generated by Django 4.0.3 on 2022-09-25 06:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inc_holder', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')])),
                ...
                ('applicant_type', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='master.applicanttype')),
                ('cust_type', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='master.customertype')),
            ],
        ),
        migrations.CreateModel(
            name='ContactPerson',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prefix', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='master.prefix')),
                ...
                ('sub_product', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='master.subproduct')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('sal_res_det_id', models.AutoField(
                    primary_key=True, serialize=False)),
                ('addi_details_id', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='account.additionaldetails')),
                ('current_location_city', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='master.city')),
                ('current_residence_type', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='master.residencetype')),
                ('state', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='master.state')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addi_details_id', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='account.additionaldetails')),
                ('investments', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='master.investmenttype')),
            ],
        ),
        migrations.CreateModel(
            name='SalExistingCreditCard',
            fields=[
                ('existing_credit_card_id', models.AutoField(
                    primary_key=True, serialize=False)),
                ...
                ('payment_delay', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')], default=False)),
                ('moratorium_taken', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')], default=False)),
                ('addi_details_id', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='account.additionaldetails')),
                ...
                ('payment_delay_year', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='master.paymentdelayyear')),
            ],
        ),
        migrations.CreateModel(
            name='SalCompanyDetails',
            fields=[
                ('comp_det_id', models.AutoField(
                    primary_key=True, serialize=False)),
                ...
                ('form_16', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')], default=False)),
                ('office_phone', models.CharField(max_length=10)),
                ('office_email', models.EmailField(max_length=50)),
                ('addi_details_id', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.CASCADE, to='account.additionaldetails')),
                ('company_name', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.CASCADE, to='master.companyname')),
                ('company_type', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.CASCADE, to='master.companytype')),
                ('designation_type', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.CASCADE, to='master.designationtype')),
                ('employment_type', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.CASCADE, to='master.employmenttype')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('add_oth_inc_id', models.AutoField(
                    primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('sal_add_det_id', models.AutoField(
                    primary_key=True, serialize=False)),
                ('inward_cheque_return', models.IntegerField()),
                ('loan_inquiry_disbursement', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')], default=False)),
                ('loan_inquiry_disbursement_details',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cc_available', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')])),
                ('oc_rec', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')])),
                ('oc_rec_floor', models.IntegerField(blank=True, null=True)),
                ('municipal_approved', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')])),
                ('area_size', models.IntegerField()),
                ('pay_till_date', models.CharField(max_length=10)),
                ('previous_aggrement_available', models.BooleanField(blank=True, choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')], null=True)),
                ('registration_done_previous_aggremnet',
                 models.CharField(max_length=100)),
                ('concern_area', models.CharField(max_length=100)),
                ('stamp_duty_registration_paid', models.BooleanField(
                    choices=[(None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')])),
                ('stamp_duty_amt', models.IntegerField(blank=True, null=True)),
                ('property_tax_paid', models.BooleanField(blank=True, choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')], null=True)),
                ('society_informed', models.BooleanField(blank=True, choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')], null=True)),
                ('car_parking_amt', models.IntegerField(blank=True, null=True)),
                ('car_parking', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')])),
                ('agreement_type', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='master.agreementtype')),
                ('apf_approved_lender', models.ManyToManyField(to='master.bankname')),
                ('area_in', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='master.areain')),
                ('area_type', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='master.areatype')),
                ('lead_id', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='account.leads')),
                ('prop_city', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='master.city')),
                ('prop_in', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='master.propertyin')),
                ('prop_state', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='master.state')),
                ('room_type', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='master.roomtype')),
                ('seller_status', models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('market_val', models.IntegerField()),
                ('prop_loc', models.CharField(max_length=50)),
                ('cc_rec', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')])),
                ('oc_rec', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')])),
                ('municipal_approved', models.BooleanField(choices=[
                ...
                ('area_size', models.IntegerField()),
                ('pay_till_date', models.CharField(max_length=10)),
                ('stamp_duty', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')])),
                ('stamp_duty_amt', models.IntegerField(blank=True, null=True)),
                ('cost_sheet', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('municipal_approved', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')])),
                ('area_size', models.IntegerField()),
                ('pay_till_date', models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loanCustomerType', models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('municipal_approved', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')])),
                ('area_size', models.IntegerField()),
                ('pay_till_date', models.DecimalField(
                    decimal_places=2, max_digits=12)),
                ('stamp_duty', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')])),
                ('stamp_duty_amt', models.CharField(max_length=10)),
                ('cost_sheet', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')], default=True)),
                ('cost_sheet_amt', models.CharField(
                    blank=True, max_length=7, null=True)),
                ('future_rent', models.IntegerField()),
                ('car_parking_amt', models.IntegerField(blank=True, null=True)),
                ('subvention_scheme', models.BooleanField(blank=True, choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')], null=True)),
                ('car_parking', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')])),
                ('agreement_type', models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('hw_per_det_id', models.AutoField(
                    primary_key=True, serialize=False)),
                ('loan_Amt', models.CharField(max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valid_rent_agreement', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')], default=False)),
                ('will_you_make_agreement', models.BooleanField(blank=True, choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')], null=True)),
                ('how_old_is_agreement', models.IntegerField(blank=True, null=True)),
                ('reflection_in_bank_account', models.BooleanField(blank=True, choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')], null=True)),
                ('rent_reflection_in_bank', models.IntegerField()),
                ('reflection_in_itr', models.BooleanField(blank=True, choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')], null=True)),
                ('extension_expected_years', models.IntegerField()),
                ('addi_details_id', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='account.additionaldetails')),
                ('agreement_type', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.CASCADE, to='master.agreementtype')),
                ('lessee_type', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.CASCADE, to='master.lessetype')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deduction_choice', models.BooleanField(blank=True, choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')], null=True)),
                ('addi_details_id', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='account.additionaldetails')),
                ('bank_name', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='master.bankname')),
                ('deduction', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.CASCADE, to='master.deductiontype')),
                ('salary_type', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.CASCADE, to='master.salarytype')),
            ],
        ),
        migrations.CreateModel(
            name='SalExistingLoanDetails',
            fields=[
                ('existing_loan_det_id', models.AutoField(
                    primary_key=True, serialize=False)),
                ...
                ('any_bounces', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')], default=False)),
                ('moratorium_taken', models.BooleanField(choices=[
                 (None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')], default=False)),
                ('addi_details_id', models.ForeignKey(
        ...
        migrations.AddField(
            ...
            name='relation',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to='master.relation'),
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('type_of_partner', models.CharField(
                    default='Hot', max_length=20)),
                ...
                ('agreement', models.FileField(
                    default='terms.pdf', upload_to='agreements')),
