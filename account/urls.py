...
urlpatterns = [
    ...
    path('additionaldetails/<int:id>',
         views.additionaldetails, name="additionaldetails"),
    ...
    path('add_applicant_additional_details/<int:id>',
         views.add_applicant_additional_details, name="add_applicant_additional_details"),
    path('add_individual_details/<int:id>',
         views.add_individual_details, name="individual_details"),
    path('retired/<int:id>', views.retired, name="retired"),
    path('salaried/<int:lead_id>/<int:additionaldetails_id>',
         views.salaried, name="salaried"),
    ...
    path('partner_detailed_view/<int:id>',
         views.partner_detailed_view, name="partner_detailed_view"),
    path('partner_detail_edit/<int:id>',
         views.partner_detail_edit, name="partner_detail_edit"),
    path('training', views.training, name="training"),
    path('upload_documents/<int:id>',
