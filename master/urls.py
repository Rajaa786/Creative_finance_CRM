...
urlpatterns = [
    ...
    path('addNatureOfBusiness/', views.NatureOfBusiness_form,
         name="NatureOfBusiness_form"),
    ...
    path('addStageOfConstruction/', views.StageOfConstruction_form,
         name="StageOfConstruction_form"),
    ...
    path('addDesignationType/', views.DesignationType_form,
         name="DesignationType_form"),
    ...
    path('editcustomertype/<int:id>',
         views.editcustomertype, name="editcustomertype"),
    ...
    path('editdesignationtype/<int:id>',
         views.editdesignationtype, name="editdesignationtype"),
    ...
    path('editresidencetype/<int:id>',
         views.editresidencetype, name="editresidencetype"),
    ...
    path('editapplicanttype/<int:id>',
         views.editapplicanttype, name="editapplicanttype"),
    ...
    path('editnatureofbusiness/<int:id>',
         views.editnatureofbusiness, name="editnatureofbusiness"),
    path('editayyear/<int:id>', views.editayyear, name="editayyear"),
    path('editagreementtype/<int:id>',
         views.editagreementtype, name="editagreementtype"),
    path('editstageofconstruction/<int:id>',
         views.editstageofconstruction, name="editstageofconstruction"),
    path('editrejectiontype/<int:id>',
         views.editrejectiontype, name="editrejectiontype"),
    path('addCommission/', views.Commission_form, name="Commission_form"),


    path('editqualification/<int:id>',
         views.editqualification, name="editqualification"),
