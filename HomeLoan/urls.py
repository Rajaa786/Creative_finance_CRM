...
urlpatterns = [
    ...
    path('incomefoirdetails/<int:id>', views.productsandpolicy_incomefoirdetails, name='ProductsAndPolicyIncomeFoirDetails'),
    ...
    path('loantovalue1details/<int:id>',views.productsandpolicy_loantovalue_1_details,name='ProductsAndPolicyLoanToValue1Details'),
    path('loantovalue2details/<int:id>',views.productsandpolicy_loantovalue_2_details,name='ProductsAndPolicyLoanToValue2Details'),
