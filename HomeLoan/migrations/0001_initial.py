...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='CostSheet',
            fields=[
                ('cost_particular_id', models.AutoField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank_id', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.CASCADE, to='HomeLoan.bank')),
                ('product', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.CASCADE, to='HomeLoan.productsandpolicy')),
            ],
        ),
        migrations.CreateModel(
            name='OtherDetailsROI',
            fields=[
                ('oth_det_roi_id', models.AutoField(
                    primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Obligation',
            fields=[
                ('obligation_id', models.AutoField(
                    primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('neg_emp_pro_id', models.AutoField(
                    primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('loan_tow_val_id', models.AutoField(
                    primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('percent_of_completion', models.FloatField(validators=[
                 django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(100.0)])),
                ('property_age', models.IntegerField(blank=True, null=True)),
                ('effective_date', models.DateTimeField(blank=True, null=True)),
                ('ineffective_date', models.DateTimeField(blank=True, null=True)),
                ('basic_details_id', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.CASCADE, to='HomeLoan.hlbasicdetails')),
                ('negative_area', models.ManyToManyField(to='master.negativearea')),
                ('pid', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='HomeLoan.productsandpolicy')),
                ('property_type', models.ManyToManyField(to='master.propertytype')),
                ('room_type', models.ManyToManyField(to='master.roomtype')),
                ('stage_of_construction', models.ManyToManyField(
                    to='master.stageofconstruction')),
            ],
        ),
        migrations.CreateModel(
            name='HlOtherDetails',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loan_amount', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='master.loanamount')),
                ('pid', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='HomeLoan.productsandpolicy')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('income_foir_percentage', models.FloatField(validators=[
                 django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(100.0)])),
                ('effective_date', models.DateTimeField(blank=True, null=True)),
                ('ineffective_date', models.DateTimeField(blank=True, null=True)),
                ('basic_details_id', models.ForeignKey(blank=True, null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bonus_avg_monthly_percentage', models.FloatField(validators=[
                 django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(100.0)])),
                ...
                ('bonus_avg_quarterly_percentage', models.FloatField(validators=[
                 django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(100.0)])),
                ...
                ('bonus_avg_half_yearly_percentage', models.FloatField(validators=[
                 django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(100.0)])),
                ...
                ('bonus_avg_yearly_percentage', models.FloatField(validators=[
                 django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(100.0)])),
                ...
                ('pid', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='HomeLoan.productsandpolicy')),
                ('rent_agreement_type', models.ForeignKey(blank=True, null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('cust_desig_id', models.AutoField(
                    primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='HomeLoan.bank')),
                ('product', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.CASCADE, to='HomeLoan.productsandpolicy')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('effective_date', models.DateTimeField(blank=True, null=True)),
                ('ineffective_date', models.DateTimeField(blank=True, null=True)),
                ('cibil_loan_type_id', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.CASCADE, to='master.cibilloantype')),
                ('pid', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='HomeLoan.productsandpolicy')),
            ],
        ),
